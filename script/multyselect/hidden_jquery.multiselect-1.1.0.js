		...
		return this.each(
						function() 
						{
							...
							if($(objMultiSelect).attr("multiple"))
							{
								...
								//console.log( options.selContainerID);
								...
								(
								 function( intIndex )
								 {
									...
									if($(this).attr("selected"))
									{
										...
										if(options.is2ShowSelected)
											displaySelected(objSelCont, $(this).text(), intIndex);
									...
									.bind("click", 
										  function(){
												if ( objOption.hasClass(options.clsUnSelectedOption) && !objOption.hasClass(options.clsSelectedOption) )
												{
													...
													if(options.is2ShowSelected)
													{
														displaySelected(objSelCont, objOption.text(), intIndex);
											  ...
											  {	
												...
												removeSelected(ID + "_sel_"+ intIndex);
											  }		
											/*---------------------------------------------------------------------------------------------------------------------------------------------------------*/
						...
						*/	
						function displaySelected(objSelBox, txtSelText, intIndex)
						{
						...
						*/
						function removeSelected(selectedOption)
						{
								...
								// Remove a hidden field within the selected option		
								$("#"+ mainBoxId + "_hid_" + arrayVal[2] ).remove();
